[![Build Status](https://travis-ci.org/Alheimsins/b5-costa-mccrae-300-ipip-neo-pi-r.svg?branch=master)](https://travis-ci.org/Alheimsins/b5-costa-mccrae-300-ipip-neo-pi-r)
...
[![Greenkeeper badge](https://badges.greenkeeper.io/Alheimsins/b5-costa-mccrae-300-ipip-neo-pi-r.svg)](https://greenkeeper.io/)
...
```
$ npm i b5-costa-mccrae-300-ipip-neo-pi-r
```

## Usage

```JavaScript
const { getItems, getInfo } = require('b5-costa-mccrae-300-ipip-neo-pi-r')
